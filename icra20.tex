...
%	interchangeably denote the robots as \emph{H, T} and $F_{i}$. 
	...
	but from $\tau+1$, such information becomes no longer available causing a need of the
	...
	At each time $t > \tau$, the position of $F_1$, $\vec{p}_{F_{1@t}}$ is observed.  
	Thus, the RTL problem is to use all the available information to predict 
	the set of poses at $t' > \tau$. 
