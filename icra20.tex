...
%	communication cost.
    ...
    available information about \emph{Follower}~1 at time $\tau$ and
    $\tau+1$ to predict $\vec{p}_{F_2@\tau}$ of \emph{Follower}~2. Then,
    at $\tau+2$, \emph{Tail} may repeat this approach centered on
    \emph{Follower}~2 to predict $\vec{p}_{F_3@\tau}$ of
    \emph{Follower~3}. Thus, after $n-1$ iterations of this approach,
    the \emph{Tail} will eventually have an estimate of the position
    $\vec{p}_{H@\tau}$ of \emph{Head} at time $\tau$.
