...
%	\label{sec:results}
	...
	\emph{Follower~2} and \emph{Head}, since the body of a \emph{Thymio} robot is around 
	...
	\begin{figure*}[t]
		...
		\caption{Sample frames with prediction results of our proposed model 
			for three different instances of $5$~robot team.
			Each row presents frames of an instance at after $1, 3, 5,$ and $7$ seconds.  
	...
	Figure~\ref{fig:preds} displays both the true positions of all robots and the predictions on 
	them. 
	the prediction outcomes of \emph{IPY-Net}, while the robot team
