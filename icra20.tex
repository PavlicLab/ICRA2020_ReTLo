...
%	are submitted as well. 
	...
	two adjacent neighbors except for the ones at both ends, which has only one 
	neighbor. 
	...
	motion rules depending on their roles, as formulated in \cite{CPR17}. This catalyzes the
	 \emph{Follower} robots and the \emph{Tail} to behave based on the current positions of their close neighbors. 
