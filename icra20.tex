...
%	In this section, we introduce more details about our method. 
	...
	Because the learned regressor is designed to work in a subteam of $3$ robots, 
	all the notations here for \emph{Head, Follower}, and \emph{Tail} all apply
	only within that smaller group.
