...
%	are submitted as well. 
	...
	cooperative localization. Rather, 
	...
	high five with robot 
	
	\subsection{Dynamics learning}
	\label{sec:dynamics_learning}
	...
	of force that affects one of the shown objects. The suggested \emph{SE3-Nets} is 
	to understand the dynamics of objects and the relationship with forces 
	possibly executed. In the RTL problem also, the \emph{Tail} robot may have known 
	...
	motions of a rigid object, while a chain of robots in our work can present 
